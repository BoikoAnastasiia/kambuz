...
- `method`: exactly one id from the method list, or null — HOW it was cooked (bake, stew, grill, fry, boil, steam, raw, no-cook). Use null only when the transcript genuinely gives no basis for it, not as a default.
